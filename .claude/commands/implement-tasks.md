...
PHASE 2: Delegate implementation to the task-implementer subagent
...
**If the user HAS provided instructions:** Proceed to PHASE 2 to delegate implementation of those specified task group(s) to the **task-implementer** subagent.
