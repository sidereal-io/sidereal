...
- `docs/planning/specs/[this-spec]/spec.md`
- `docs/planning/specs/[this-spec]/planning/requirements.md`
...
- `docs/planning/specs/[this-spec]/spec.md` (if present)
- `docs/planning/specs/[this-spec]/planning/requirements.md` (if present)
- `docs/planning/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `docs/planning/specs/[this-spec]/tasks.md`
